...
log = logging.getLogger("feedback_studio.lib.patcher")

from aes_utils import aes_cfb128_decrypt, aes_cfb128_encrypt
...
def decrypt_toc(data):
    return aes_cfb128_decrypt(ARC_KEY, ARC_IV, data)


def encrypt_toc(data):
    return aes_cfb128_encrypt(ARC_KEY, ARC_IV, data)
